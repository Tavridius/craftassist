"""Таймер Электрошторма на Кузне-11 (событие до 30.09.2026).
...
UNTIL = "2026-09-30"   # последний день события (было 23.09, продлено патчем 16.09)
...
class EStorm:
    ...
    def snapshot(self, now: datetime | None = None,
        ...
        # событие кончается в конце дня UNTIL по МСК
