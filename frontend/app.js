    ...
    <div class="h2-hud-grid">
      ...
      <main class="h2-view">
        <!-- Промокоды — самой первой строкой центра, выше главного экрана.
             ...
             (/craft +93% в день переезда); полоса поэтому сделана в одну
             строку кодов, а не в блок. Смотреть /craft и /market в следующем
             срезе — если просядут, это плата за место. -->
