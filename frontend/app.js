...
function home2Hud(d) {
  return `<div class="h2 h2-hud">
    ...
    <div class="h2-hud-grid">
      <aside class="h2-rail">
        <!-- Промокоды стоят первыми в рейке, выброс третьим. На старом дашборде
             промокоды были одной из десяти равных плиток и давали цель
             promo_ref_click в 1.05% визитов; в первый день ПУЛЬТА, где они уехали
             третьими в рейку, — 0.24%. Выброс от места не зависит (за ним
             приходят намеренно), реферальный код живёт только с глаз. -->
