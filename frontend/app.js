  ...
  return `<div class="h2 h2-hud">
    ...
    <div class="h2-hud-grid">
      ...
      <main class="h2-view">
        ...
        <!-- Промокоды вернулись в центр под главный экран. История места:
             на старом дашборде это была одна из десяти равных плиток и цель
             promo_ref_click срабатывала в 1.05% визитов; в ПУЛЬТЕ модуль уехал
             в левую рейку и дал 0.24%, после подъёма первым в рейке (81f0a6f)
             за 08.08 — ноль. За два дня 1/764 против 20/1908, p=0.015: это уже
             не шум. Рейка тут безнадёжна by design — с 1200px и уже она в
             сетке уходит ПОД весь центр («view news» / «rail news»), то есть
             на большинстве ноутбуков реферальный код лежит ниже сгиба.
             Ставим под hero, а не над ним: крафт и аук — верх воронки
             (/craft +93% в день переезда), их двигать нельзя. -->
