...
REGION=RU
# Лимит prod-API: 400 запросов/мин (~6.7/с). 0.25 → ~4/с: цикл ≈ 4.6 мин,
# запас ~40% на /history и внеочередной прогрев (0.1 давал ~4% ответов 429).
AUCTION_MIN_INTERVAL=0.25
CRAFT_MAX_DEPTH=6
